...
const appleObj = {
  ...
  addOrganic(organic1, organic2) {
    ...
    console.log('es6 var1: ' + this.var1);
    console.log(`outside obj fun: ${growObj.pourWater()}`);
    ...
    // const that = this; // for accessing var1 inside forEach method of an array, not preffered
